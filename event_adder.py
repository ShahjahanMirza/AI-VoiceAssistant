...
class GoogleCalendar:
    ...
    def get_events(self):
        try:
            ...
            event_result = self.service.events().list(calendarId='primary', timeMin=now, maxResults=3, singleEvents=True, orderBy='startTime').execute() 
...
# calendar.add_event(response_json)
